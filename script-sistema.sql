...
CREATE TABLE
    IF NOT EXISTS tipo_materia_prima(
...
CREATE TABLE
    IF NOT EXISTS unidad_de_medida(
...
CREATE TABLE
    IF NOT EXISTS devolucion_proveedor(
...
CREATE TABLE
    IF NOT EXISTS devolucion_cliente(
